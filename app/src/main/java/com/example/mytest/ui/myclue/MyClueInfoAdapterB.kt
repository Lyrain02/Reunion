...
class MyClueInfoAdapterB (val infolist:List<myfindMsg>) : RecyclerView.Adapter<MyClueInfoAdapterB.ViewHolder>(){
    private val tag = "MyClueInfoAdapterB"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        viewHolder.itemView.setOnClickListener {
            ...
            val intent = Intent(view.context, bDetailActivity::class.java)
